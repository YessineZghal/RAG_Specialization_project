"""A plain dense retriever — the fixed, non-adaptive baseline every
strategy in this level is compared against. Same brute-force cosine
approach as every prior level.
"""
